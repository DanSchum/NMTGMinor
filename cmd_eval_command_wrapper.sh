...
outputReadme=$outputDirectory"README.txt"
touch $outputReadme
echo "Model: "$1 >> $outputReadme
echo "Source Dataset for Eval: "$2 >> $outputReadme
echo "Target Dataset for Eval: "$3 >> $outputReadme
